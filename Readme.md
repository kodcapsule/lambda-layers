...
A lambda layer is a spercial container , a .zip file archive  that  containes supplementary code or data. Lambda layers serves as a distribution mechanisim for function dependencies,custom runtimes, or configuration files for your lambda functions. Layers let you keep your functions deployment packages small and organized by separating your function code from its dependencies.
...
To ensure that Lambda picks up your layer content, your layer .zip file should have its dependencies in the following folder paths:
- 1. Python: python, python/lib/python3.x/site-packages (site directories)
- 2. Nodejs: nodejs/node_modules, 
...
Layers can be:
- Private to your AWS account
- Shared with specific AWS accounts
- Made public to all AWS users

This flexibility allows for controlled code sharing within organizations or even contribution to the broader serverless community.
...
In this section i will walk you through  the process of creating and using  Lambda Layers. In this demo i will be creating a python layer.
